...
- `--jsonl-explicit-null`: emit null JSON fields and map values for `jsonl` and `jsonl-ext`.
...
- JSONL output omits null fields and map values by default; pass `--jsonl-explicit-null`
