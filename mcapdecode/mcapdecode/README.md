...
```toml
[dependencies]
mcapdecode = { version = "0.5.1", default-features = false, features = ["protobuf"] }
```
...
```toml
[dependencies]
mcapdecode = { version = "0.5.1", default-features = false, features = ["arrow", "protobuf"] }
```
...
```toml
[dependencies]
mcapdecode = { version = "0.5.1", features = ["arrow"] }
```
