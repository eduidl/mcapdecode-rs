...
```toml
[dependencies]
mcapdecode = { version = "0.7.0", default-features = false, features = ["protobuf"] }
```
...
```toml
[dependencies]
mcapdecode = { version = "0.7.0", default-features = false, features = ["arrow", "protobuf"] }
```
...
```toml
[dependencies]
mcapdecode = { version = "0.7.0", features = ["arrow"] }
```
